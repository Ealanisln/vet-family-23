            ...
            <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12'>
                    ...
                    <div className='col-span-7 flex flex-col justify-evenly relative'>
                        ...
                        <h1 className='text-midnightblue text-4xl md:text-85xl text-center lg:text-start font-semibold lh-133 pt-5'>Bienvenido a Family Vet</h1>
                        <h3 className='text-black opacity-75 text-lg font-normal text-center lg:text-start pt-8'>Porque entendemos que tu mascota no es solo un animal, sino parte de tu familia. Por ello ofrecemos el mejor servicio para tu mejor amigo. Nuestro compromiso es proporcionar atención de alta calidad y amorosa para garantizar la salud y felicidad de tus peludos.</h3>
