...
import { SaleListItem } from "@/types/pos"; // Update this import to use the SaleListItem type
...
interface SalesTableProps {
  sales: SaleListItem[]; // Change this to use SaleListItem[] instead of Sale[]
  pagination: {
    total: number;
    pages: number;
    page: number;
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        ...
        <CardDescription>Listado de ventas realizadas</CardDescription>
      </CardHeader>
      <CardContent>
        {/* Filtros */}
