...
import { ServiceCategory } from "@prisma/client"; // Importar ServiceCategory desde Prisma
...
export default async function NewServicePage() {
  ...
  async function handleCreateService(formData: FormData) {
    ...
    try {
      ...
      const category = formData.get("category") as ServiceCategory; // Tipar correctamente como ServiceCategory
