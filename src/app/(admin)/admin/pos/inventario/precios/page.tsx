...
import { ArrowLeft, DollarSign, Tag, TrendingUp } from "lucide-react";
...
export const metadata: Metadata = {
  ...
  description:
    "Administra los precios y costos de los productos del inventario",
};
    ...
    <div className="container py-6">
      ...
      <Tabs defaultValue="products" className="space-y-6">
        ...
        <TabsContent value="products" className="space-y-6">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle>Listado de Productos ({total})</CardTitle>
              <CardDescription>
