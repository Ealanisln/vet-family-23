        ...
        <div className="flex items-center py-3 space-x-4">
          ...
          <div className="flex-1 space-y-0.5">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2">
              ...
              />
              <p className="font-medium text-base text-yellow-800">
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="flex items-center bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600 transition-colors whitespace-nowrap text-sm font-medium"
            >
              Más info
            </Link>
