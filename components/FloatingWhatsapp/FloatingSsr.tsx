...
import { WhatsappSVG, CloseSVG, CheckSVG, SendSVG } from "./assets/icons";
import css from "@/app/styles/floatingwhats.module.css";
...
export default function FloatingSsr({
  onClick,
  onSubmit,
  onClose,
  onNotification,
  ...
  avatar = dummyAvatar,
  statusMessage = "Regularmente responde en 1 hora o menos.",
